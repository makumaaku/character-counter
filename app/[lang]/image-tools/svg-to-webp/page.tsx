...
export default async function SvgToWebp({ params }: Props) {
  ...
  const [
    ...
    // SEOテキスト関連の翻訳
    translate(lang, 'imageTools.svgToWebp.seoText.overview.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.overview.content'),
    translate(lang, 'imageTools.svgToWebp.seoText.howTo.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.howTo.steps.0.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.howTo.steps.0.description'),
    translate(lang, 'imageTools.svgToWebp.seoText.howTo.steps.1.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.howTo.steps.1.description'),
    translate(lang, 'imageTools.svgToWebp.seoText.howTo.steps.2.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.howTo.steps.2.description'),
    translate(lang, 'imageTools.svgToWebp.seoText.testimonials.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.testimonials.users.0.name'),
    translate(lang, 'imageTools.svgToWebp.seoText.testimonials.users.0.comment'),
    translate(lang, 'imageTools.svgToWebp.seoText.testimonials.users.1.name'),
    translate(lang, 'imageTools.svgToWebp.seoText.testimonials.users.1.comment'),
    translate(lang, 'imageTools.svgToWebp.seoText.testimonials.users.2.name'),
    translate(lang, 'imageTools.svgToWebp.seoText.testimonials.users.2.comment'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.items.0.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.items.0.description'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.items.1.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.items.1.description'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.items.2.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.items.2.description'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.items.3.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.features.items.3.description'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.title'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.0.question'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.0.answer'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.1.question'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.1.answer'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.2.question'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.2.answer'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.3.question'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.3.answer'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.4.question'),
    translate(lang, 'imageTools.svgToWebp.seoText.faq.questions.4.answer')
  ])
  ...
  return (
    <PageContainer>
      <SvgToWebpClient translations={messages} />
