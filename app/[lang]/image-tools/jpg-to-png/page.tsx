...
export default async function JpgToPng({ params }: Props) {
  ...
  const [
    ...
    // SEOテキスト関連の翻訳
    translate(lang, 'imageTools.jpgToPng.seoText.overview.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.overview.content'),
    translate(lang, 'imageTools.jpgToPng.seoText.howTo.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.howTo.steps.0.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.howTo.steps.0.description'),
    translate(lang, 'imageTools.jpgToPng.seoText.howTo.steps.1.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.howTo.steps.1.description'),
    translate(lang, 'imageTools.jpgToPng.seoText.howTo.steps.2.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.howTo.steps.2.description'),
    translate(lang, 'imageTools.jpgToPng.seoText.testimonials.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.testimonials.users.0.name'),
    translate(lang, 'imageTools.jpgToPng.seoText.testimonials.users.0.comment'),
    translate(lang, 'imageTools.jpgToPng.seoText.testimonials.users.1.name'),
    translate(lang, 'imageTools.jpgToPng.seoText.testimonials.users.1.comment'),
    translate(lang, 'imageTools.jpgToPng.seoText.testimonials.users.2.name'),
    translate(lang, 'imageTools.jpgToPng.seoText.testimonials.users.2.comment'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.items.0.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.items.0.description'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.items.1.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.items.1.description'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.items.2.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.items.2.description'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.items.3.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.features.items.3.description'),
    translate(lang, 'imageTools.jpgToPng.seoText.faq.title'),
    translate(lang, 'imageTools.jpgToPng.seoText.faq.questions.0.question'),
    translate(lang, 'imageTools.jpgToPng.seoText.faq.questions.0.answer'),
    translate(lang, 'imageTools.jpgToPng.seoText.faq.questions.1.question'),
    translate(lang, 'imageTools.jpgToPng.seoText.faq.questions.1.answer'),
    translate(lang, 'imageTools.jpgToPng.seoText.faq.questions.2.question'),
    translate(lang, 'imageTools.jpgToPng.seoText.faq.questions.2.answer'),
